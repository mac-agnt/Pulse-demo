# McGrane Precast Pulse demo

Frontend-only Pulse operations mockup for **McGrane Precast** (McGrath Group), greeting **Yanka Laila Alves**.
...
| `Pulse v4 Glass.dc.html` | Same McGrane demo; this is the template's historical primary filename. |
...
https://cdn.jsdelivr.net/gh/mac-agnt/Pulse-demo@mcgrane-precast/
