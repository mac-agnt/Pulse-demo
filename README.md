# Eco Horizon Pulse demo

Frontend-only Pulse operations mockup for **Eco Horizon**, greeting **Ciarán Kells**.
...
| `Pulse v4 Glass.dc.html` | Same Eco Horizon demo; this is the template's historical primary filename. |
...
https://cdn.jsdelivr.net/gh/mac-agnt/Pulse-demo@eco-horizon/
